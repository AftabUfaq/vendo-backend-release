module.exports = {
  ...
  getPopulatedData: (
    ...
    return new Promise((resolve, reject) => {
      let query = model.find(find).select(projection);
  ...
  getPopulatedDataWithLimit: (
    ...
    return new Promise((resolve, reject) => {
      model
        .find(find)
        .populate({ path: profile, select: select })
        .select(projection)
        .limit(limit)
  ...
  updateOneData: (model, match = {}, data = {}, projection = {}) => {
    return new Promise((resolve, reject) => {
      model
        .updateOne(match, data, { new: true }, (err, result) => {
          if (err) {
            console.log(err);
            reject({ data: [], error: err });
          } else {
  ...
  updateOneDataPushUniqueWithoutSet: (
    model,
    match = {},
    data = {},
    pushdata = {}
