...
router.post('/add_user/', validation, async (req, res) => {
    ...
    upload(req, res, async (err) => {
        ...
        try {
            ...
            let { data, error } = await db.insertOneData(UserModel, {...req.body, ...extraBody})
...
router.post('/login', async (req, res) => {
    ...
    try {
        ...
        let { data, error } = await db.getData(UserModel, { email: email, password: pass, deactivate: false }, {
            _id: 0, id: "$_id", email: 1, name: 1, isAdmin: 1
        })
...
router.post('/resetPassword', validation,async (req, res) => {
    ...
    try {
        ...
        let response = await db.getData(UserModel, { email: email, password: pass }, {
        ...
        if (response.error === null) {
            if (response.data.length > 1) {
                ...
                let { data, error } = await db.updateOneData(UserModel, { _id: id }, { password: newpass }, {
                    _id: 0, id: "$_id"
                })
...
router.post('/sendOtp/', async (req, res) => {
    ...
    try {
        ...
        let { data, error } = await db.getData(UserModel, { email: email }, {
...
router.post('/resetOtpPassword', async (req, res) => {
    ...
    try {
        ...
        if (data.length > 1) {
            ...
            let response = await db.updateOneData(UserModel, { _id: id }, { password: newpass }, {
                _id: 1, id: "$_id", uid: 1, email: 1
            })
...
router.post('/updateUser', validation, async (req, res) => {
    ...
    upload(req, res, async (err) => {
        ...
        try {
            ...
            let { data, error } = await db.updateOneData(UserModel, { _id: newid }, {...body, ...extraBody}, {
                _id: 0, id: "$_id"
            })
...
router.get('/getOneUser/:id', validation, async (req, res) => {
    ...
    try {
        ...
        let { data, error } = await db.getData(UserModel, { _id: id }, {
            _id: 0, id: "$_id", email: 1, name: 1, isAdmin: 1, deactivate: 1
        })
...
router.get('/getAllUsers/', validation, async (req, res) => {
    ...
    try {
        ...
        let { data, error } = await db.getData(UserModel, {}, {
            _id: 0, id: "$_id", email: 1, name: 1, isAdmin: 1, deactivate: 1
        })
