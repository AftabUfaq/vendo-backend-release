...
router.get('/categories', async (req, res, next) => {
  ...
  try {
    ...
    let { data, error } = await db.getData(CategoryModel, {}, {
      _id: 0, id: "$_id", categoryName: 1
    })

    if (error === null) {
      resBody.status = true
      resBody.result = data.length > 0 ? data[0].categoryName : []
      resBody.id = data.length > 0 ? JSON.parse(JSON.stringify(data[0])).id : ""
    } else {
...
router.get('/getallcategory', async (req, res, next) => {
  ...
  try {
    ...
    let query = req.query || {};
    let { data, error } = await db.getData(CategorynModel, {}, {
      _id: 0, id: "$_id", Name: 1, type: 1
    })
...
router.get('/getonecategory/:id', async (req, res, next) => {
  ...
  try {
    ...
    let { data, error } = await db.getData(CategorynModel, { _id: id }, {
      _id: 0, id: "$_id", Name: 1, type: 1
    })
...
router.get('/getcategory', async (req, res, next) => {
  ...
  try {
    ...
    let query = req.query || {};
    let { data, error } = await db.getData(CategorynModel, { type: query.type }, {
      _id: 0, id: "$_id", Name: 1, type: 1
    })
...
router.post('/add_new_categories/', async (req, res) => {
  ...
  try {
    ...
    let getData = await db.getData(CategorynModel, { Name: req.body.Name }, {
      _id: 0, id: "$_id", Name: 1, type: 1
    })
    ...
    if (getData.error === null) {
      if (getData.data.length > 0) {
        ...
        let { data, error } = await db.insertOneData(CategorynModel, { Name: req.body.Name, type: req.body.type })
...
router.post('/add_categories/', validation, async (req, res) => {
  ...
  try {
    ...
    let getData = await db.getData(CategoryModel, {}, {
      _id: 0, id: "$_id", categoryName: 1
    })
    ...
    if (getData.error === null) {
      if (getData.data.length > 0) {
        ...
        let { data, error } = await db.updateOneDataPushUnique(CategoryModel, { _id: id }, body, pushBody)
        ...
        let { data, error } = await db.insertOneData(CategoryModel, { ...req.body })
...
router.get('/getAllTransactions/', validation, async (req, res) => {
  ...
  try {
    let { data, error } = await db.getPopulatedData(TransactionModel, {}, "_products._product _products._quantity _products._price", {
      _id: 0, id: "$_id", name: 1, deactivate: 1, maxQuantity: 1, category: 1, size: 1, ingredients: 1, status: 1, shortDescription: 1, longDescription: 1, productImage: "$productImage.url", price: 1
    }, {
      _id: 0, id: "$_id", _customer: 1, _provider: 1, totalPrice: 1, deliveryCost: 1, paymentMode: 1, paypalTranasctionId: 1, timestamp: 1
    })
...
router.get('/getOrderDetailsByProvider/', validation, async (req, res) => {
  ...
  try {
    ...
    let { data, error } = await db.getPopulatedData(TransactionModel, { _provider: pid }, "_products._product _products._quantity _products._price", {
      _id: 0, id: "$_id", name: 1, deactivate: 1, maxQuantity: 1, category: 1, size: 1, ingredients: 1, status: 1, shortDescription: 1, longDescription: 1, productImage: "$productImage.url", price: 1
    }, {
      _id: 0, id: "$_id", _customer: 1, _provider: 1, totalPrice: 1, deliveryCost: 1, paymentMode: 1, paypalTranasctionId: 1, timestamp: 1
    })
...
router.get('/getOrderDetailsByCustomer/', validation, async (req, res) => {
  ...
  try {
    ...
    let { data, error } = await db.getPopulatedData(TransactionModel, { _customer: cid }, "_products._product _products._quantity _products._price", {
      _id: 0, id: "$_id", name: 1, deactivate: 1, maxQuantity: 1, category: 1, size: 1, ingredients: 1, status: 1, shortDescription: 1, longDescription: 1, productImage: "$productImage.url", price: 1
    }, {
      _id: 0, id: "$_id", _customer: 1, _provider: 1, totalPrice: 1, deliveryCost: 1, paymentMode: 1, paypalTranasctionId: 1, timestamp: 1
    })
...
router.post('/addToCart/', validation, async (req, res) => {
  ...
  try {
    ...
    if (cartClear == true) {
      ...
      let { data, error } = await db.updateOneDataPush(CustomerModel, { _id: cid }, {}, {
        _cart: products
      })
...
router.post('/updateCartItem/', validation, async (req, res) => {
  ...
  try {
    ...
    let { data, error } = await db.updateOneDataPush(CustomerModel, { _id: cid, "_cart._id": itemId }, {
...
router.post('/removeItemFromCart/', validation, async (req, res) => {
  ...
  try {
    ...
    //   }
    //   else{
    let { data, error } = await db.removeOneDataObject(CustomerModel, { _id: cid }, {
      _cart: {
        _id: itemId
      }
    }, {})
...
router.get('/getCart/', async (req, res) => {
  ...
  try {
    ...
    let { data, error } = await db.getPopulatedData(CustomerModel, { _id: cid }, "_cart._product _cart._id _cart._quantity _cart._pid", {
      _id: 0, id: "$_id", name: 1, deactivate: 1, maxQuantity: 1, category: 1, size: 1, ingredients: 1, status: 1, shortDescription: 1, longDescription: 1, productImage: "$productImage.url", price: 1
    }, {
    ...
    if (error === null) {
      for (var i = 0; i < data[0]._cart.length; i++) {
        let provider = await db.getData(ProviderModel, { _id: data[0]._cart[0]._pid }, { _id: 0, id: "$_id", email: 1, providerName: 1, postcode: 1, address: 1, region: 1, postcode: 1, branch: 1, telephone: 1, mobile: 1, domain: 1, logo: "$logo.url", deactivate: 1, emailVerified: 1, availability: 1, paypalMode: 1, cashMode: 1, flyer: "$flyer.url", category: 1, companyPresentation: "$companyPresentation.url", companyPresentationStartDay: 1, companyPresentationEndDay: 1, advertisement: "$advertisement.url", advertisementStartDay: 1, advertisementEndDay: 1, flyerStartDay: 1, flyerEndDay: 1, jobAdvertisement: "$jobAdvertisement.url", jobAdvertisementStartDay: 1, jobAdvertisementEndDay: 1, menu: "$menu.url", menuStartDay: 1, menuEndDay: 1, info: "$info.url", infoStartDay: 1, infoEndDay: 1, event: "$event.url", eventStartDay: 1, eventEndDay: 1, advertisingVideo: "$advertisingVideo.url", advertisingVideoStartDay: 1, advertisingVideoEndDay: 1, deliveryCost: 1, minOrderCost: 1, openTime: 1, closeTime: 1, orderStartDay: 1, orderEndDay: 1, paypalClientSecret: 1, paypalClientId: 1, deliveryCircle: 1, deliveryApproxTime: 1, iswelcome: 1, community: 1, description: 1, Imprint: 1,Abholung:1,Lieferung:1 })
...
router.get('/sendnotification/', async (req, res) => {
  ...
  try {
    ...
    if (type == 1) {
      ...
      message = 'Sie haben die Bestellung bestätigt. Ihr Kunde wurde entsprechend per Push Nachricht informiert'
      subject = 'Ihre Bestellung wurde von ' + pname + ' ' + ' bestätigt'
    }
    else if (type == 2) {
      //message='Ihre Bestellung wurde storniert'
      message = 'Sie haben die Bestellung storniert. Ihr Kunde wurde entsprechend per Push Nachricht informiert'
      ...
      message = 'Die Bestellung wird nun ausgeliefert. Ihr Kunde wurde entsprechend per Push Nachricht informiert'
    ...
    let { data, error } = await db.getData(CustomerModel, { _id: cid },
      {
        _id: 0, id: "$_id", email: 1, userName: 1, name: 1, street: 1,
        number: 1, postcode: 1, place: 1, region: 1, mobile: 1, email: 1,
        deliveryNote: 1, picture: "$picture.url", deactivate: 1, emailVerified: 1, token: 1
      })
    ...
    let { data1, error1 } = await db.insertOneData(NotificationModel,
      { cid: cid, pid: pid, message: message, create_date: date_ob, type: type, subject: subject, pname: pname })
    ...
    console.log("Error", e)
    //resBody.msg = "Something went wrong"
    res.render('order_page', { title: 'Error', subject: 'Something went wrong' });
    return false;
  }
...
router.get('/getnotification', async (req, res, next) => {
  ...
  try {
    ...
    let query = req.query || {};
    let { data, error } = await db.getData(NotificationModel, { pid: query.pid }, {
      _id: 0, id: "$_id", cid: 1, type: 1, pid: 1, create_date: 1, message: 1, subject: 1, pname: 1
    })
...
router.get('/getnotificationbycid', async (req, res, next) => {
  ...
  try {
    ...
    let query = req.query || {};
    let { data, error } = await db.getData(NotificationModel, { cid: query.cid }, {
      _id: 0, id: "$_id", cid: 1, type: 1, pid: 1, create_date: 1, message: 1, subject: 1
    })
...
router.get('/privacyPolicy', async (req, res, next) => {
  res.render('privacy_policy', { title: 'Express', subject: 'This is example' });
});
...
router.get('/prfeed/:user_id', async (req, res, next) => {
  ...
  if (provider_details.length > 0) {
    ...
    for (var i = 0; i < provider_details.length; i++) {
      ...
      for (let index = 0; index < provider_details[i].PRFeedData.length; index++) {
          if (provider_details[i].PRFeedData[index].subject_line && provider_details[i].PRFeedData[index].input_text) {
          if (provider_details[i].PRFeedData[index].feed_show_status === false) {
            continue;
          }
          let provider_details_seen1 = await ProviderDetailsSeen.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'feed',PRFeedId:provider_details[i].PRFeedData[index]._id }).exec();
 
          let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'feed',PRFeedId:provider_details[i].PRFeedData[index]._id }).exec();
          let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'feed',PRFeedId:provider_details[i].PRFeedData[index]._id }).exec();
          let like_status;
          let wished_status;
          if (like) {
            like_status = true;
          ...
          if (Wished) {
            ...
            if(new Date().toISOString()>=provider_details[i].PRFeedData[index].post_start_date && new Date().toISOString()<=provider_details[i].PRFeedData[index].post_end_date){
            results.push({
              ...
              post_start_date: provider_details[i].PRFeedData[index].post_start_date,
              post_end_date: provider_details[i].PRFeedData[index].post_end_date,
              picture_1:provider_details[i].PRFeedData[index].picture_1.url? 'https://' + hostname + provider_details[i].PRFeedData[index].picture_1.url:'',
              picture_2:provider_details[i].PRFeedData[index].picture_2.url? 'https://' + hostname + provider_details[i].PRFeedData[index].picture_2.url:'',
              feed_show_status: provider_details[i].PRFeedData[index].feed_show_status,
              ...
              wishlist_count: provider_details[i].PRFeedData[index].wishlist_count,
              like_status: provider_details[i].PRFeedData[index]._id.toString() === like?.PRFeedId || false,
              seen_status: provider_details_seen1?.type === 'feed' || false,
              type: 'feed',
              PrFeedId: provider_details[i].PRFeedData[index]._id,
              wished_status: provider_details[i].PRFeedData[index]._id.toString() === Wished?.PRFeedId || false,
      ...
      if (provider_details[i].company_presentation_subject_line && provider_details[i].company_presentation_input_text) {
        if (provider_details[i].company_presentation_feed_show_status === true) {
          let provider_details_seen2 = await ProviderDetailsSeen.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'company_presentation' }).exec();

          let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'company_presentation' }).exec();
          let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'company_presentation' }).exec();
          let like_status;
          let wished_status;
          if (like) {
            like_status = true;
          ...
          if(new Date().toISOString()>=provider_details[i].companyWelcomeStartDay && new Date().toISOString()<=provider_details[i].companyWelcomeEndDay){
            results.push({
              provider: provider_details[i]._id,
              subject_line: provider_details[i].company_presentation_subject_line,
              ...
              picture_1:provider_details[i].company_presentation_picture_1?.url? 'https://' + hostname + provider_details[i].company_presentation_picture_1?.url:'',
              picture_2:provider_details[i].company_presentation_picture_2?.url? 'https://' + hostname + provider_details[i].company_presentation_picture_2?.url:'',
              fileUrl:{
                url:provider_details[i].companyPresentation.url,
                mimetype:provider_details[i].companyPresentation.mimetype,
              } ,
              feed_show_status: provider_details[i].company_presentation_feed_show_status,
              providerName: provider_details[i].providerName,
              logo: 'https://' + hostname + provider_details[i].logo?.url,
              like_count: provider_details[i].company_presentation_like_count,
              wishlist_count: provider_details[i].company_presentation_wishlist_count,
              like_status: like_status,
              seen_status: provider_details_seen2?.type === 'company_presentation',
      ...
      if (provider_details[i].job_advertisement_subject_line && provider_details[i].job_advertisement_input_text) {
        if (provider_details[i].job_advertisement_feed_show_status === true) {
          let provider_details_seen3 = await ProviderDetailsSeen.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'job_advertisement' }).exec();

          let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'job_advertisement' }).exec();
          let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'job_advertisement' }).exec();
          let like_status;
          let wished_status;
          if (like) {
            like_status = true;
          ...
          if(new Date().toISOString()>=provider_details[i].jobAdvertisementWelcomeStartDay && new Date().toISOString()<=provider_details[i].jobAdvertisementWelcomeEndDay){
            results.push({
              provider: provider_details[i]._id,
              subject_line: provider_details[i].job_advertisement_subject_line,
              input_text: provider_details[i].job_advertisement_input_text,
              post_start_date: provider_details[i].jobAdvertisementWelcomeStartDay,
              post_end_date: provider_details[i].jobAdvertisementWelcomeEndDay,
              picture_1:provider_details[i].job_advertisement_picture_1?.url? 'https://' + hostname + provider_details[i].job_advertisement_picture_1?.url:'',
              picture_2:provider_details[i].job_advertisement_picture_2?.url? 'https://' + hostname + provider_details[i].job_advertisement_picture_2?.url:'',
              fileUrl:{
                url:provider_details[i].jobAdvertisement.url,
                mimetype:provider_details[i].jobAdvertisement.mimetype,
              } ,
              feed_show_status: provider_details[i].job_advertisement_feed_show_status,
              providerName: provider_details[i].providerName,
              logo: 'https://' + hostname + provider_details[i].logo?.url,
              like_count: provider_details[i].job_advertisement_like_count,
              wishlist_count: provider_details[i].job_advertisement_wishlist_count,
              like_status: like_status,
      ...
      if (provider_details[i].flyer_subject_line && provider_details[i].flyer_input_text) {
        if (provider_details[i].flyer_feed_show_status === true) {
          let provider_details_seen4 = await ProviderDetailsSeen.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'flyer' }).exec();

          let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'flyer' }).exec();
          let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'flyer' }).exec();
          let like_status;
          let wished_status;
          if (like) {
            like_status = true;
          ...
          if(new Date().toISOString()>=provider_details[i].flyerWelcomeStartDay && new Date().toISOString()<=provider_details[i].flyerWelcomeEndDay){
            results.push({
              provider: provider_details[i]._id,
              ...
              picture_1:provider_details[i].flyer_picture_1?.url? 'https://' + hostname + provider_details[i].flyer_picture_1?.url:'',
              picture_2: provider_details[i].flyer_picture_2?.url?'https://' + hostname + provider_details[i].flyer_picture_2?.url:'',
              fileUrl:{
                url:provider_details[i].flyer.url,
                mimetype:provider_details[i].flyer?.mimetype,
              } ,
      ...
      if (provider_details[i].advertisement_subject_line && provider_details[i].advertisement_input_text) {
        if (provider_details[i].advertisement_feed_show_status === true) {
          let provider_details_seen5 = await ProviderDetailsSeen.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'advertisement' }).exec();

          let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'advertisement' }).exec();
          let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'advertisement' }).exec();
          let like_status;
          let wished_status;
          if (like) {
            like_status = true;
          ...
          if(new Date().toISOString()>=provider_details[i].advertisementWelcomeStartDay && new Date().toISOString()<=provider_details[i].advertisementWelcomeEndDay){
            results.push({
              provider: provider_details[i]._id,
              ...
              picture_1:hostname + provider_details[i].advertisement_picture_1?.url? 'https://' + hostname + provider_details[i].advertisement_picture_1?.url:'',
              picture_2:provider_details[i].advertisement_picture_2?.url? 'https://' + hostname + provider_details[i].advertisement_picture_2?.url:'',
              fileUrl:{
                url:provider_details[i].advertisement.url,
                mimetype:provider_details[i].advertisement?.mimetype,
              } ,
              feed_show_status: provider_details[i].advertisement_feed_show_status,
              providerName: provider_details[i].providerName,
              logo: 'https://' + hostname + provider_details[i].logo?.url,
      ...
      if (provider_details[i].menu_subject_line && provider_details[i].menu_input_text) {
        if (provider_details[i].menu_feed_show_status === true) {
          let provider_details_seen6 = await ProviderDetailsSeen.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'menu' }).exec();

          let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'menu' }).exec();
          let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'menu' }).exec();
          let like_status;
          let wished_status;
          if (like) {
            like_status = true;
          ...
          if(new Date().toISOString()>=provider_details[i].menuWelcomeStartDay && new Date().toISOString()<=provider_details[i].menuWelcomeEndDay){
            results.push({
              provider: provider_details[i]._id,
              ...
              picture_1:provider_details[i].menu_picture_1?.url? 'https://' + hostname + provider_details[i].menu_picture_1?.url:'',
              picture_2:provider_details[i].menu_picture_2?.url? 'https://' + hostname + provider_details[i].menu_picture_2?.url:'',
              fileUrl:{
                url:provider_details[i].menu.url,
                mimetype:provider_details[i].menu?.mimetype,
              } ,
      ...
      if (provider_details[i].info_subject_line && provider_details[i].info_input_text) {
        if (provider_details[i].info_feed_show_status === true) {
          let provider_details_seen6 = await ProviderDetailsSeen.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'info' }).exec();

          let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'info' }).exec();
          let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'info' }).exec();
          let like_status;
          let wished_status;
          if (like) {
            like_status = true;
          ...
          if(new Date().toISOString()>=provider_details[i].infoWelcomeStartDay && new Date().toISOString()<=provider_details[i].infoWelcomeEndDay){
            results.push({
              provider: provider_details[i]._id,
              ...
              picture_1:provider_details[i].info_picture_1?.url? 'https://' + hostname + provider_details[i].info_picture_1?.url:'',
              picture_2:provider_details[i].info_picture_2?.url? 'https://' + hostname + provider_details[i].info_picture_2?.url:'',
              fileUrl:{
                url:provider_details[i].info.url,
                mimetype:provider_details[i].info?.mimetype,
              } ,
      ...
      if (provider_details[i].event_subject_line && provider_details[i].event_input_text) {
        if (provider_details[i].event_feed_show_status === true) {
          let provider_details_seen7 = await ProviderDetailsSeen.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'event' }).exec();

          let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'event' }).exec();
          let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'event' }).exec();
          let like_status;
          let wished_status;
          if (like) {
            like_status = true;
          ...
          if(new Date().toISOString()>=provider_details[i].eventWelcomeStartDay && new Date().toISOString()<=provider_details[i].eventWelcomeEndDay){
            results.push({
              provider: provider_details[i]._id,
              ...
              picture_1:provider_details[i].event_picture_1?.url? 'https://' + hostname + provider_details[i].event_picture_1?.url:'',
              picture_2:provider_details[i].event_picture_2?.url? 'https://' + hostname + provider_details[i].event_picture_2?.url:'',
              fileUrl:{
                url:provider_details[i].event.url,
                mimetype:provider_details[i].event?.mimetype,
              } ,
      ...
      if (provider_details[i].advertising_video_subject_line && provider_details[i].advertising_video_input_text) {
        if (provider_details[i].advertising_video_feed_show_status === true) {
          let provider_details_seen8 = await ProviderDetailsSeen.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'advertising_video' }).exec();

          let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'advertising_video' }).exec();
          let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'advertising_video' }).exec();
          let like_status;
          let wished_status;
          if (like) {
            like_status = true;
          ...
          if(new Date().toISOString()>=provider_details[i].advertisingVideoWelcomeStartDay && new Date().toISOString()<=provider_details[i].advertisingVideoWelcomeEndDay){
            results.push({
              provider: provider_details[i]._id,
              subject_line: provider_details[i].advertising_video_subject_line,
              input_text: provider_details[i].advertising_video_input_text,
              post_start_date: provider_details[i].advertisingVideoWelcomeStartDay,
              post_end_date: provider_details[i].advertisingVideoWelcomeEndDay,
              picture_1:provider_details[i].advertising_video_picture_1?.url? 'https://' + hostname + provider_details[i].advertising_video_picture_1?.url:'',
              picture_2:provider_details[i].advertising_video_picture_2?.url? 'https://' + hostname + provider_details[i].advertising_video_picture_2?.url:'',
              fileUrl:{
                url:provider_details[i].advertisingVideo.url,
                mimetype:provider_details[i].advertisingVideo?.mimetype,
              } ,
              feed_show_status: provider_details[i].advertising_video_feed_show_status,
              providerName: provider_details[i].providerName,
              logo: 'https://' + hostname + provider_details[i].logo?.url,
              like_count: provider_details[i].advertising_video_like_count,
              wishlist_count: provider_details[i].advertising_video_wishlist_count,
              like_status: like_status,
    ...
    res.send({ success: true, message: "PR list", data: results.sort(function(a, b) {
...
// console.log(req.body,"??????????");
  var provider_details = await ProviderModel.findOne({ "_id": provider_id }).exec();
  // console.log();
  // var provider_like_details = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_id }).exec();


  if(PRFeedId){
    var provider_like_details = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_id,type:type,PRFeedId:PRFeedId }).exec();
  }else{
    var provider_like_details = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_id,type:type }).exec();
  }
  ...
  switch (type) {
    case 'feed':
      if (provider_like_details) {
        let new_wishlist_count_temp = provider_details.PRFeedData.find(ele=>ele._id.toString()===PRFeedId)
        let new_wishlist_count = new_wishlist_count_temp.like_count - 1;
        await ProviderModel.updateOne({ "_id": provider_id,"PRFeedData._id":PRFeedId }, {
          "PRFeedData.$.like_count": new_wishlist_count
        }).exec();

        await ProviderLike.deleteOne({ "user_id": user_id, "provider_id": provider_id,type:type,PRFeedId: PRFeedId }).exec();
    ...
    case 'company_presentation':
      if (provider_like_details) {
        let new_wishlist_count = parseInt(provider_details.company_presentation_like_count) - 1;
        await ProviderModel.updateOne({ "_id": provider_id }, {
          "company_presentation_like_count": new_wishlist_count
        }).exec();

        await ProviderLike.deleteOne({ "user_id": user_id, "provider_id": provider_id,type:type }).exec();
    ...
    case 'job_advertisement':
      if (provider_like_details) {
        let new_wishlist_count = parseInt(provider_details.job_advertisement_like_count) - 1;
        await ProviderModel.updateOne({ "_id": provider_id }, {
    ...
    case 'flyer':
      if (provider_like_details) {
        let new_wishlist_count = parseInt(provider_details.flyer_like_count) - 1;
        await ProviderModel.updateOne({ "_id": provider_id }, {
    ...
    case 'advertisement':
      if (provider_like_details) {
        let new_wishlist_count = parseInt(provider_details.advertisement_like_count) - 1;
        await ProviderModel.updateOne({ "_id": provider_id }, {
    ...
    case 'event':
      if (provider_like_details) {
        let new_wishlist_count = parseInt(provider_details.event_like_count) - 1;
        await ProviderModel.updateOne({ "_id": provider_id }, {
    ...
    case 'advertising_video':
      if (provider_like_details) {
        let new_wishlist_count = parseInt(provider_details.advertising_video_like_count) - 1;
        await ProviderModel.updateOne({ "_id": provider_id }, {
...
router.get('/prfeedDetails/:provider_id/:user_id/:type', async (req, res, next) => {
  ...
  if (provider_details) {
    ...
    if(PrFeedId){
      var like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details._id.toString(),type:type,PRFeedId:PrFeedId }).exec();
    }else{
      var like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details._id.toString(),type:type }).exec();
    }
    // if (like) {
    ...
    if(PrFeedId){
      var Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details._id.toString(),type:type,PRFeedId:PrFeedId }).exec();
    }else{
      var Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details._id.toString(),type:type }).exec();
    }
    ...
    if(PrFeedId){
      var provider_details_seen = await ProviderDetailsSeen.findOne({ "user_id": user_id.toString(), "provider_id": provider_id.toString(),type:type,PRFeedId:PrFeedId }).exec();
    }else{
      var provider_details_seen = await ProviderDetailsSeen.findOne({ "user_id": user_id.toString(), "provider_id": provider_id.toString(),type:type }).exec();
    }
    ...
    if (type === 'feed') {
      let obj = provider_details.PRFeedData.find(o => o._id.toString() === PrFeedId);
      provider_data = {
        ...
        pictures: [obj.picture_1?.url?'https://' + hostname + obj.picture_1?.url:'',obj.picture_2?.url? 'https://' + hostname + obj.picture_2?.url:''],
        // picture_1: 'https://' + hostname + provider_details.picture_1?.url,
        // picture_2: 'https://' + hostname + provider_details.picture_2?.url,
        picture_1:obj.picture_1?.url ? 'https://' + hostname + obj.picture_1?.url:'',
        picture_2:obj.picture_2?.url ? 'https://' + hostname + obj.picture_2?.url:'',
    ...
    if (type === 'company_presentation') {
      provider_data = {
        ...
        pictures: [provider_details.company_presentation_picture_1?.url?'https://' + hostname + provider_details.company_presentation_picture_1?.url:'', 'https://' + hostname +provider_details.company_presentation_picture_2?.url? provider_details.company_presentation_picture_2?.url:''],
        picture_1:provider_details.company_presentation_picture_1?.url? 'https://' + hostname + provider_details.company_presentation_picture_1?.url:'',
        picture_2:provider_details.company_presentation_picture_2?.url? 'https://' + hostname + provider_details.company_presentation_picture_2?.url:'',
        feed_show_status: provider_details.company_presentation_feed_show_status,
        providerName: provider_details.providerName,
        logo: 'https://' + hostname + provider_details.logo.url,
    ...
    if (type === 'job_advertisement') {
      provider_data = {
        ...
        pictures: [provider_details.job_advertisement_picture_1?.url?'https://' + hostname + provider_details.job_advertisement_picture_1?.url:'', provider_details.job_advertisement_picture_2?.url? 'https://' + hostname + provider_details.job_advertisement_picture_2?.url:''],
        picture_1:provider_details.job_advertisement_picture_1?.url? 'https://' + hostname + provider_details.job_advertisement_picture_1?.url:'',
        picture_2:provider_details.job_advertisement_picture_2?.url? 'https://' + hostname + provider_details.job_advertisement_picture_2?.url:'',
    ...
    if (type === 'flyer') {
      provider_data = {
        ...
        pictures: [provider_details.flyer_picture_1?.url?'https://' + hostname + provider_details.flyer_picture_1?.url:'',provider_details.flyer_picture_2?.url? 'https://' + hostname + provider_details.flyer_picture_2?.url:''],
        picture_1:provider_details.flyer_picture_1?.url? 'https://' + hostname + provider_details.flyer_picture_1?.url:'',
        picture_2:provider_details.flyer_picture_2?.url? 'https://' + hostname + provider_details.flyer_picture_2?.url:'',
    ...
    if (type === 'advertisement') {
      provider_data = {
        ...
        pictures: [provider_details.advertisement_picture_1?.url?'https://' + hostname + provider_details.advertisement_picture_1?.url:'',provider_details.advertisement_picture_2?.url? 'https://' + hostname + provider_details.advertisement_picture_2?.url:''],
        picture_1:provider_details.advertisement_picture_1?.url? 'https://' + hostname + provider_details.advertisement_picture_1?.url:'',
        picture_2:provider_details.advertisement_picture_2?.url? 'https://' + hostname + provider_details.advertisement_picture_2?.url:'',
    ...
    if (type === 'menu') {
      provider_data = {
        ...
        pictures: [provider_details.menu_picture_1?.url?'https://' + hostname + provider_details.menu_picture_1?.url:'',provider_details.menu_picture_2?.url? 'https://' + hostname + provider_details.menu_picture_2?.url:''],
        picture_1:provider_details.menu_picture_1?.url? 'https://' + hostname + provider_details.menu_picture_1?.url:'',
        picture_2:provider_details.menu_picture_2?.url? 'https://' + hostname + provider_details.menu_picture_2?.url:'',
    ...
    if (type === 'info') {
      provider_data = {
        ...
        pictures: [provider_details.info_picture_1?.url?'https://' + hostname + provider_details.info_picture_1?.url:'',provider_details.info_picture_2?.url? 'https://' + hostname + provider_details.info_picture_2?.url:''],
        picture_1:provider_details.info_picture_1?.url? 'https://' + hostname + provider_details.info_picture_1?.url:'',
        picture_2:provider_details.info_picture_2?.url? 'https://' + hostname + provider_details.info_picture_2?.url:'',
    ...
    if (type === 'event') {
      provider_data = {
        ...
        pictures: [provider_details.event_picture_1?.url?'https://' + hostname + provider_details.event_picture_1?.url:'',provider_details.event_picture_2?.url? 'https://' + hostname + provider_details.event_picture_2?.url:''],
        picture_1:provider_details.event_picture_1?.url? 'https://' + hostname + provider_details.event_picture_1?.url:'',
        picture_2:provider_details.event_picture_2?.url? 'https://' + hostname + provider_details.event_picture_2?.url:'',
    ...
    if (type === 'advertising_video') {
      provider_data = {
        ...
        pictures: [provider_details.advertising_video_picture_1?.url?'https://' + hostname + provider_details.advertising_video_picture_1?.url:'',provider_details.advertising_video_picture_2?.url? 'https://' + hostname + provider_details.advertising_video_picture_2?.url:''],
        picture_1:provider_details.advertising_video_picture_1?.url? 'https://' + hostname + provider_details.advertising_video_picture_1?.url:'',
        picture_2:provider_details.advertising_video_picture_2?.url? 'https://' + hostname + provider_details.advertising_video_picture_2?.url:'',
...
router.post('/feedWishlist', async (req, res, next) => {
  ...
  var provider_details = await ProviderModel.findOne({ "_id": provider_id }).exec();
if(PRFeedId){
  var provider_like_details = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_id,type:type,PRFeedId:PRFeedId }).exec();
}else{
  var provider_like_details = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_id,type:type }).exec();
}
  ...
  switch (type) {
    case 'feed':
      if (provider_like_details) {
        ...
        await ProviderWishlist.deleteOne({ "user_id": user_id, "provider_id": provider_id,type:type,PRFeedId: PRFeedId }).exec();
    ...
    case 'company_presentation':
      if (provider_like_details) {
        let new_wishlist_count = parseInt(provider_details.company_presentation_wishlist_count) - 1;
        await ProviderModel.updateOne({ "_id": provider_id }, {
          "company_presentation_wishlist_count": new_wishlist_count
        }).exec();

        await ProviderWishlist.deleteOne({ "user_id": user_id, "provider_id": provider_id,type:type }).exec();
    ...
    case 'job_advertisement':
      if (provider_like_details) {
        let new_wishlist_count = parseInt(provider_details.job_advertisement_wishlist_count) - 1;
        await ProviderModel.updateOne({ "_id": provider_id }, {
    ...
    case 'flyer':
      if (provider_like_details) {
        let new_wishlist_count = parseInt(provider_details.flyer_wishlist_count) - 1;
        await ProviderModel.updateOne({ "_id": provider_id }, {
    ...
    case 'advertisement':
      if (provider_like_details) {
        let new_wishlist_count = parseInt(provider_details.advertisement_wishlist_count) - 1;
        await ProviderModel.updateOne({ "_id": provider_id }, {
    ...
    case 'menu':
      if (provider_like_details) {
        let new_wishlist_count = parseInt(provider_details.menu_wishlist_count) - 1;
        await ProviderModel.updateOne({ "_id": provider_id }, {
    ...
    case 'info':
      if (provider_like_details) {
        let new_wishlist_count = parseInt(provider_details.info_wishlist_count) - 1;
        await ProviderModel.updateOne({ "_id": provider_id }, {
    ...
    case 'event':
      if (provider_like_details) {
        let new_wishlist_count = parseInt(provider_details.event_wishlist_count) - 1;
        await ProviderModel.updateOne({ "_id": provider_id }, {
    ...
    case 'advertising_video':
      if (provider_like_details) {
        let new_wishlist_count = parseInt(provider_details.advertising_video_wishlist_count) - 1;
        await ProviderModel.updateOne({ "_id": provider_id }, {
  ...
  if (provider_details.length > 0) {
    ...
    for (var i = 0; i < provider_details.length; i++) {
        ...
        for (let index = 0; index < provider_details[i].PRFeedData.length; index++) {
          ...
          let provider_details_seen1 = await ProviderDetailsSeen.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'feed',PRFeedId:provider_details[i].PRFeedData[index]._id }).exec();
          ...
          if(provider_details[i].PRFeedData[index]._id.toString() === Wished?.PRFeedId){
            if(new Date().toISOString()>=provider_details[i].PRFeedData[index].post_start_date && new Date().toISOString()<=provider_details[i].PRFeedData[index].post_end_date){
            results.push({
              provider: provider_details[i]._id,
              subject_line: provider_details[i].PRFeedData[index].subject_line,
      ...
      if (provider_details[i].company_presentation_subject_line && provider_details[i].company_presentation_input_text) {
        if (provider_details[i].company_presentation_feed_show_status === false) {
          continue;
        }
        let provider_details_seen2 = await ProviderDetailsSeen.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'company_presentation' }).exec();

        let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'company_presentation' }).exec();
        let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'company_presentation' }).exec();
        let like_status;
        let wished_status;
        if (like) {
      ...
      if (provider_details[i].job_advertisement_subject_line && provider_details[i].job_advertisement_input_text) {
        ...
        let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'job_advertisement' }).exec();
        let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'job_advertisement' }).exec();
        let like_status;
        let wished_status;
        if (like) {
      ...
      if (provider_details[i].flyer_subject_line && provider_details[i].flyer_input_text) {
        ...
        let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'flyer' }).exec();
        let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'flyer' }).exec();
        let like_status;
        let wished_status;
        if (like) {
      ...
      if (provider_details[i].advertisement_subject_line && provider_details[i].advertisement_input_text) {
        ...
        let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'advertisement' }).exec();
        let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'advertisement' }).exec();
        let like_status;
        let wished_status;
        if (like) {
        ...
        if (Wished) {
          ...
          results.push({
            ...
            post_start_date: provider_details[i].advertisementWelcomeStartDay,
            post_end_date: provider_details[i].advertisementWelcomeEndDay,
            picture_1:provider_details[i].advertisement_picture_1?.url? 'https://' + hostname + provider_details[i].advertisement_picture_1?.url:'',
            picture_2:provider_details[i].advertisement_picture_2?.url? 'https://' + hostname + provider_details[i].advertisement_picture_2?.url:'',
            feed_show_status: provider_details[i].advertisement_feed_show_status,
            providerName: provider_details[i].providerName,
            logo: 'https://' + hostname + provider_details[i].logo?.url,
      ...
      if (provider_details[i].menu_subject_line && provider_details[i].menu_input_text) {
        ...
        let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'menu' }).exec();
        let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'menu' }).exec();
      ...
      if (provider_details[i].info_subject_line && provider_details[i].info_input_text) {
        ...
        let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'info' }).exec();
        let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'info' }).exec();
        let like_status;
        let wished_status;
        if (like) {
      ...
      if (provider_details[i].event_subject_line && provider_details[i].event_input_text) {
        ...
        let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'event' }).exec();
        let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'event' }).exec();
        let like_status;
        let wished_status;
        if (like) {
      ...
      if (provider_details[i].advertising_video_subject_line && provider_details[i].advertising_video_input_text) {
        ...
        let like = await ProviderLike.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id,type:'advertising_video' }).exec();
        let Wished = await ProviderWishlist.findOne({ "user_id": user_id, "provider_id": provider_details[i]._id.toString(),type:'advertising_video' }).exec();
        let like_status;
        let wished_status;
        if (like) {
...
router.post('/providerLike', async (req, res, next) => {
  ...
  var provider_like_details = await ProviderLikeRoot.findOne({ "user_id": user_id, "provider_id": provider_id }).exec();
  if (provider_like_details) {
    var new_like_count = parseInt(provider_details.like_count) - 1;
    await ProviderModel.updateOne({ "_id": provider_id }, {
      "like_count": new_like_count,
    ...
    await ProviderLikeRoot.deleteOne({ "user_id": user_id, "provider_id": provider_id }).exec();
...
router.post('/providerWishlist', async (req, res, next) => {
  ...
  var provider_like_details = await ProviderWishlistRoot.findOne({ "user_id": user_id, "provider_id": provider_id }).exec();
  if (provider_like_details) {
    ...
    await ProviderWishlistRoot.deleteOne({ "user_id": user_id, "provider_id": provider_id }).exec();
